...
<style type="text/css">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <div style="background-color: #FFF; padding: 30px 50px 30px 50px;">
            <img src="<?php echo $raizProy?>img/logo_globmint2.png" class="img-responsive" style='margin-left: auto; margin-right: auto; max-height: 270px' />
            ...
            <form class="m-t" method="post" role="form" action="login.php">
                ...
                <div class="input-group m-b" style="text-align: left">
                    ...
                    <div style="display: inline-block; vertical-align: middle; font-size: 14px; width: 40%; text-align: center">&nbsp;@globmint.com</div>
                </div>
