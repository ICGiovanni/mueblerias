            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Confirmar borrar Gasto</h5>
                        <div class="ibox-tools">
							<button type="button" class="btn btn-danger btn-xs" onclick="location.href = '../';">Cancelar</button>&nbsp;&nbsp;
                            <button id="boton_crea_gasto" type="button" class="btn btn-primary btn-xs" onclick="borrar_gasto('<?=$rowGasto["gasto_id"]?>');"><i class="fa fa-trash"></i> ELIMINAR GASTO</button> <span id="span_crea_gasto"></span>
