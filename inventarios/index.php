            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    foreach($movimientos as $m)
                    {
                    	...
                    	$tr.='<a href="#" class="link_modal" data-toggle="modal" data-target="#modal_view" data-id="'.$movimiento_id.'"  id="open_modal"><i class="fa fa-search"></i></a>';
                    	if($estatus=='PE')
                    	{
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#recibir_productos").click(function()
            {
            	...
            	$.ajax(
				{
    		        url: "inventario.php?t=r&id="+move_id,
    		        type: 'POST',
    		        async: false,
