...
$html.='<table style="text-align:center;font-size: 8px;">';
$html.='<tr>';
...
$html.='<td align="rigth"><div><strong>2 / 2</strong></div></td>';
$html.='</tr>';
$html.='</table><br><br>';
...
$html.='<tr><td align="left"><strong>Datos de ENTRADA:</strong></td></tr>';
$html.='<tr><td align="left"></td></tr>';
$html.='<tr><td align="left"><strong>Salida Encargado:</strong> '.$result['usuario_entrega'].'</td></tr>';
$html.='<tr><td align="left"><strong>Salida Sucursal:</strong> '.$result['sucursal_entrega'].'</td></tr>';
$html.='<tr><td align="left"><strong>Fecha de Salida:</strong> '.$general->getDateSimple($result['fecha_entrega']).'</td></tr>';
$html.='<tr><td align="left"></td></tr>';
...
$html.='<tr><td align="left"><strong>Observaciones:</strong> '.$result['nota_entrega'].'</td></tr>';
$html.='<tr><td></td><td align="center"></td></tr>';
